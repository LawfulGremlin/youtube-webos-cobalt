export default {
  ui: {
    ...
    adblock: 'Bloquear anúncios', sponsoredQrCodeBlock: 'Bloquear pop-ups de códigos QR patrocinados', autoLogin: 'Ignorar automaticamente a seleção de conta', sponsorblock: 'Ativar SponsorBlock', ryd: 'Mostrar contagem de não gostei', shorts: 'Ativar YouTube Shorts',
  ...
  sponsorBlock: {
    sponsor: 'patrocinador', intro: 'introdução', outro: 'encerramento', interaction: 'interação',
    selfpromo: 'autopromoção', music_offtopic: 'fora do assunto', preview: 'prévia', filler: 'enrolação',
    hook: 'saudação', skipping: 'Pulando'
  }
};
