export default {
  ui: {
    ...
    adblock: 'Blokuj reklamy', sponsoredQrCodeBlock: 'Blokuj sponsorowane wyskakujące kody QR', autoLogin: 'Automatycznie pomijaj wybór konta', sponsorblock: 'Włącz SponsorBlock', ryd: 'Pokaż liczbę negatywnych ocen',
