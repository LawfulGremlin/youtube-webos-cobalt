export default {
  ui: {
    ...
    adblock: 'Bloquear anuncios', sponsoredQrCodeBlock: 'Bloquear ventanas emergentes de códigos QR patrocinados', startupPage: 'Página de inicio', startupPageHome: 'Inicio', startupPageSubscriptions: 'Suscripciones', startupPageShorts: 'Shorts', startupPageLibrary: 'Biblioteca', autoLogin: 'Omitir automáticamente la selección de cuenta', sponsorblock: 'Activar SponsorBlock', ryd: 'Mostrar recuento de no me gusta',
